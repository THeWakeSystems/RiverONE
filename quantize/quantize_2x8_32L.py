...
"""
=============================================================================
 RiverOne-QC-4B-v2 AQLM 量化 — 2×8 scheme, 后32层
...
qm.OUTPUT_DIR = os.path.join(os.path.dirname(SCRIPT_DIR), "RiverOne-QC-4B-v2-AQLM-2x8-32L")
qm.LOG_FILE = os.path.join(SCRIPT_DIR, "quantize_2x8_32L.log")

qm.NUM_LAST_LAYERS = 32
qm.NUM_CODEBOOKS = 2
qm.NBITS_PER_CODEBOOK = 8
qm.NSAMPLES = 64
...
if __name__ == "__main__":
    ...
    qm.logger.info("=" * 60)
    qm.logger.info(" AQLM 2×8 量化 — 后32层 LLM (多模态校准)")
    qm.logger.info(f" num_codebooks=2, nbits_per_codebook=8")
