...
qm.OUTPUT_DIR = os.path.join(os.path.dirname(SCRIPT_DIR), "RiverOne-QC-4B-v2-AQLM-2x16-8L-Attn14MLP16-nredo5")
qm.LOG_FILE = os.path.join(SCRIPT_DIR, "quantize_2x16_8L_attn14_mlp16_nredo5.log")
...
qm.FAISS_NREDO = 5  # ★ nredo=5 K-Means优化
...
def _patched_save(model, output_dir, source_dir):
    ...
    if os.path.exists(qc_path):
        with open(qc_path, "r") as f:
            qc = json.load(f)
        qc["scheme"] = "2x16-Attn14MLP16-8L-nredo5"
        qc["num_codebooks"] = 2
